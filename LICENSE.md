Copyright (c) 2021 Kyber Studio, licensed under Polyform Perimeter 1.0.0 with examples
...
* [Examples of what is NOT allowed to do with the software under this license](#examples-of-what-is-not-allowed-to-do-with-the-software-under-this-license)
...
* Offer any kind of "Quebec vaccine passport storage/validation"-as-a-Service using any parts of the QR Québec source code.
* Using e.g. the QR Québec source code to offer a similar solution.
